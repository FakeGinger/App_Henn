...
public class AStern : MonoBehaviour
{
    ...
    public Notification_Scriptable UI_NoPath;
    public GameObject RoomUI;
    public GameObject DoorWindowUI;
    ...
    public Notification_Scriptable moreRoomsNeeded;

    public GameObject finalDoor;
    public GameObject keys;

    public GameObject notOkay;
    public GameObject pathOkay;
    ...
    {
        counter = roomCollector.transform.childCount;
        if (counter >= 3)
        {
            ...
            var finish = new Tile();
            finish.X = Mathf.RoundToInt(finishP.transform.position.x); 
