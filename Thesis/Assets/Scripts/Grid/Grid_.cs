...
public class Grid_<TGridObject>
{
    ...
    public Grid_(int width, int height, float cellSize, Vector3 originPosition, Func<Grid_<TGridObject>, int, int, TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
        ...
        //Zeichnet das Grid auf dem Boden. Die Sachen innerhalb der For-Schleife sind die Zahlen, alles darunter die Linien
        bool showDebug = true;
        if (showDebug)
        {
